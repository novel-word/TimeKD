...
from data_provider.forecasting_loader import data_provider, arg_setup_forecasting
from data_provider.classification_loader_emb import (
    load_all_datasets,
...
def load_classification_dataloader(args, normalize, data_path, mode="pretrain"):
    assert args.task_name == "classification"
    dataset_folder = Path("/data/cxliu/code/NeurIPS2023-One-Fits-All/Long-term_Forecasting/ST_LLM/data/classification") / args.data_path
    (
        train_dataset,
        train_loader,
        valid_dataset,
        ...
        test_dataset,
        test_loader,
    ) = load_all_datasets(args, mode, dataset_folder, normalize=normalize, data_path=data_path)
