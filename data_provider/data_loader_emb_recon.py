...
class Dataset_ETT_hour(Dataset):
    def __init__(self, root_path="/data/cxliu/code/NeurIPS2023-One-Fits-All/Long-term_Forecasting/ST_LLM/data", flag='train', size=None, 
        ...
        # self.embed_path = f"/data/cxliu/code/NeurIPS2023-One-Fits-All/Long-term_Forecasting/ST_LLM/TimeCMA/TimeKD/Embeddings/gt/{data_path_file}/{flag}/"
        self.embed_path = f"/data/cxliu/code/NeurIPS2023-One-Fits-All/Long-term_Forecasting/ST_LLM/TimeCMA/TimeKD/Embeddings/HD_GT/ll6/{data_path_file}/{self.pred_len}/{flag}/"
...
class Dataset_ETT_minute(Dataset):
    ...
    def __read_data__(self):
        ...
        if self.timeenc == 0:
            ...
            df_stamp['minute'] = df_stamp.date.apply(lambda row: row.hour, 1)
...
class Dataset_Custom(Dataset):
    def __init__(self, root_path="/data/cxliu/code/NeurIPS2023-One-Fits-All/Long-term_Forecasting/ST_LLM/data", flag='train', size=None,
        ...
        self.model_name = model_name
        self.embed_path = f"./Embeddings/HD_GT/mask/{data_path_file}/{flag}/"
        # self.embed_path = f"./Embeddings/HD_GT/mask/{data_path_file}/{self.pred_len}/{flag}/"
...
class Dataset_PEMS(Dataset):
    def __init__(self, root_path="/data/cxliu/code/NeurIPS2023-One-Fits-All/Long-term_Forecasting/ST_LLM/data", flag='train', size=None,
        ...
        self.embed_path = f"./Embeddings/GT_FT/{data_path_file}/{flag}/"
