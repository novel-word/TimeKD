...
class Dataset_Classification(Dataset):
    def __init__(self, dataset, means, stds, percent, normalize):
        super().__init__()
...
def load_all_datasets(args, mode, dataset_folder, normalize=False):
    ...
    train_dataset = Dataset_Classification(train_dataset, means, stds, percent, normalize=normalize)
    valid_dataset = Dataset_Classification(valid_dataset, means, stds, percent, normalize=normalize)
    test_dataset = Dataset_Classification(test_dataset, means, stds, percent, normalize=normalize)
