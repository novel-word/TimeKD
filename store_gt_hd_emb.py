...
from data_provider.data_loader_save import Dataset_ETT_hour, Dataset_ETT_minute, Dataset_Custom, Dataset_PEMS
from prompt_hd_gt_mask_replace_off import GenPromptEmb
...
def save_embeddings(args):
    ...
    save_path = f"./Embeddings/HD_GT/ll12/{args.data_path}/{args.output_len}/{args.divide}/"
    os.makedirs(save_path, exist_ok=True)

    emb_time_path = f"./Results/emb_time/HD_GT/ll12/"
